...
class Library {
  ...
  editLibrary(book) {
    ...
    if (checkOpenConfirm.length === 0) {
      ...
      const newBookButtonsDiv =
        bookDataIndex[book].querySelector(".newBookButtonsDiv");
      ...
      const titleTextArea =
        bookDataIndex[book].querySelector(".newBookTitleDiv");
      const titleTextContent = titleTextArea.querySelector(
        ".newBookTitleContent"
      );
      ...
      const authorTextArea =
        bookDataIndex[book].querySelector(".newBookAuthorDiv");
      const authorTextContent = authorTextArea.querySelector(
...
function checkCurrentLibrary() {
  ...
  if (newLibrary.books.length === 0) {
    ...
    emptyLibMsg.innerText =
      "There are no current books in your library! Add some books above.";
    ...
    const emptyLibMsgCheck = document.querySelector(
